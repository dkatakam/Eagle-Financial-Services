...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Investment'), array('action' => 'delete', $investment['Investment']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $investment['Investment']['id']))); ?> </li>
