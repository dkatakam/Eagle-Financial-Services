...
<?php echo $this->Form->create('Bond'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bond'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Bond.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Bond.id')))); ?></li>
